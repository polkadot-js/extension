...
export const TxTypeNameMap: Record<string, string> = {
  ...
  [ExtrinsicType.SEND_NFT]: 'NFT transaction',
  [ExtrinsicType.CROWDLOAN]: 'Crowdloan contribution',
  [ExtrinsicType.STAKING_JOIN_POOL]: 'Join pool',
  [ExtrinsicType.STAKING_LEAVE_POOL]: 'Leave pool',
  ...
  [ExtrinsicType.STAKING_COMPOUNDING]: 'Stake compound',
