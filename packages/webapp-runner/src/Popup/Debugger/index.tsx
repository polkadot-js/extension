...
import DebuggerLogoPreview from "@subwallet-webapp/Popup/Debugger/DebuggerLogoPreview";
  ...
  return (
    <div className={className}>
      <div className="select-mode">
        ...
        <Button disabled={mode === "api"} onClick={applyMode("api")} size="xs">
          API
        </Button>
        <Button
          disabled={mode === "logo"}
...
export const Debugger = styled(Component)<Props>(
