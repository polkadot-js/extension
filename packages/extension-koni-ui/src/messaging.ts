...
export async function checkTuringCompoundTask (address: string): Promise<ExistingTuringCompoundTask> {
  return sendMessage('pri(staking.checkTuringCompoundTask)', address);
}
