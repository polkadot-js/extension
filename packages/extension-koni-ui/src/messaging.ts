...
export async function submitPoolWithdrawal (request: RequestStakePoolingWithdrawal): Promise<SWTransactionResponse> {
  return sendMessage('pri(bonding.nominationPool.submitWithdrawal)', request);
}
