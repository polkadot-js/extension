...
const Component: React.FC<Props> = (props: Props) => {
  ...
  const onUpdate: FormCallbacks<ExportFormState>["onFieldsChange"] =
    useCallback(
  ...
  const onSubmit: FormCallbacks<ExportFormState>["onFinish"] = useCallback(
    (values: ExportFormState) => {
      ...
      >
        <div className="body-container">
          <div className={CN("notice", { "mb-large": !firstStep })}>
            <AlertBox
              description={t(
                "Anyone with your  keys can steal any assets held in your account."
              )}
          ...
          {firstStep && (
            ...
            >
              ...
              <Form.Item className="mb-0" name={FormFieldName.TYPES}>
                <div className="export-types-container">
                  {items.map((item) => {
                    ...
                    return (
                      <SettingItem
                        className={CN("export-item", `export-${item.type}`, {
                          selected: _selected,
          ...
          {!firstStep && (
            ...
            >
              {exportTypes.includes(ExportType.PRIVATE_KEY) && (
                <div className="result-content">
                  <div className="result-title">
                    {t(titleMap[ExportType.PRIVATE_KEY])}
                  </div>
                  <Field
              ...
              {exportTypes.includes(ExportType.SEED_PHRASE) && (
                <div className="result-content">
                  <div className="result-title">
                    {t(titleMap[ExportType.SEED_PHRASE])}
                  </div>
              ...
              {exportTypes.includes(ExportType.QR_CODE) && (
                <div className="result-content">
                  <div className="result-title">
                    {t(titleMap[ExportType.QR_CODE])}
                  </div>
                  <div className="qr-area">
                    <QRCode errorLevel="Q" size={264} value={qrData} />
                  </div>
                </div>
              )}
                ...
                <div className="result-content">
                  ...
                  {exportSingle && (
                    <>
                      ...
                      <div className="json-done-tile">{t("Success!")}</div>
...
const AccountExport = styled(Component)<Props>(
  ({ theme: { token } }: Props) => {
    return {
      ".body-container": {
