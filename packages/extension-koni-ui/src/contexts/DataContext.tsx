...
export const DataContextProvider = ({ children }: DataContextProviderProps) => {
  ...
  _DataContext.addHandler({ ...subscribeIsShowPopup, name: 'subscribeIsShowPopup', relatedStores: ['campaign'], isStartImmediately: true });
