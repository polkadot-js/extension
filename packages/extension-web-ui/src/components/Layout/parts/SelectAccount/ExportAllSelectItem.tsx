...
import { useAccountAvatarInfo, useAccountAvatarTheme } from '@subwallet/extension-web-ui/hooks';
import { Theme } from '@subwallet/extension-web-ui/themes';
import { AccountSignMode, PhosphorIcon } from '@subwallet/extension-web-ui/types';
...
function Component (props: _AccountCardItem): React.ReactElement<_AccountCardItem> {
  ...
  const iconProps: IconProps | undefined = useMemo((): IconProps | undefined => {
    switch (signMode) {
      case AccountSignMode.GENERIC_LEDGER || AccountSignMode.LEGACY_LEDGER:
        return {
          type: 'icon',
          value: Swatches
        };
