...
import { LANGUAGE } from "@subwallet-webapp/constants/localStorage";
import { lazySubscribeMessage } from "@subwallet-webapp/messaging";
import { store } from "@subwallet-webapp/stores";
import { AppSettings } from "@subwallet-webapp/stores/types";
import { buildHierarchy } from "@subwallet-webapp/util/account/buildHierarchy";
...
export const updateCurrentAccountState = (currentAccountJson: AccountJson) => {
  store.dispatch({
    type: "accountState/updateCurrentAccount",
    payload: currentAccountJson,
  });
};
...
export const updateAuthorizeRequests = (data: AuthorizeRequest[]) => {
  ...
  store.dispatch({
    type: "requestState/updateAuthorizeRequests",
    payload: requests,
  });
};
...
export const updateMetadataRequests = (data: MetadataRequest[]) => {
  ...
  store.dispatch({
    type: "requestState/updateMetadataRequests",
    payload: requests,
  });
};
...
export const updateSigningRequests = (data: SigningRequest[]) => {
  ...
  store.dispatch({
    type: "requestState/updateSigningRequests",
    payload: requests,
  });
};
...
export const updateConfirmationRequests = (data: ConfirmationsQueue) => {
  store.dispatch({
    type: "requestState/updateConfirmationRequests",
    payload: data,
  });
};
...
export const updateTransactionRequests = (
  data: Record<string, SWTransactionResult>
) => {
  // Convert data to object with key as id

  store.dispatch({
    type: "requestState/updateTransactionRequests",
    payload: data,
  });
};
...
export const updateShowZeroBalanceState = (isShow: boolean) => {
  store.dispatch({
    type: "settings/updateShowZeroBalanceState",
    payload: isShow,
  });
};
...
export const updateBrowserConfirmationType = (
  type: AppSettings["browserConfirmationType"]
) => {
  store.dispatch({
    type: "settings/updateBrowserConfirmationType",
    payload: type,
  });
};
...
export const subscribeAuthUrls = lazySubscribeMessage(
...
export const updateMultiChainAssetRegistry = (
  data: Record<string, _MultiChainAsset>
) => {
  store.dispatch({
    type: "assetRegistry/updateMultiChainAssetMap",
    payload: data,
  });
};
...
export const updateAssetSettingMap = (data: Record<string, AssetSetting>) => {
  store.dispatch({
    type: "assetRegistry/updateAssetSettingMap",
    payload: data,
  });
};
...
export const subscribePrice = lazySubscribeMessage(
...
export const subscribeNftItems = lazySubscribeMessage(
...
export const updateStakingReward = (data: StakingRewardJson) => {
  store.dispatch({
    type: "staking/updateStakingReward",
    payload: [...data.fastInterval, ...data.slowInterval],
  });
};
