...
import { useFilterModal, useGetValidatorList, useGetYieldMetadata, useGetYieldPositionInfo, useSelectValidators, ValidatorDataType } from '@subwallet/extension-web-ui/hooks';
import { ThemeProps } from '@subwallet/extension-web-ui/types';
import { getValidatorKey } from '@subwallet/extension-web-ui/utils';
...
const Component = (props: Props, ref: ForwardedRef<InputRef>) => {
  ...
  const yieldInfo = useGetYieldPositionInfo(slug, from);
