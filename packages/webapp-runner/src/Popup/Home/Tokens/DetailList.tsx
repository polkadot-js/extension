...
import PageWrapper from "@subwallet-webapp/components/Layout/PageWrapper";
...
import { TokenBalanceDetailItem } from "@subwallet-webapp/components/TokenItem/TokenBalanceDetailItem";
...
import { DetailModal } from "@subwallet-webapp/Popup/Home/Tokens/DetailModal";
import { DetailUpperBlock } from "@subwallet-webapp/Popup/Home/Tokens/DetailUpperBlock";
...
function Component(): React.ReactElement {
  ...
  const onOpenSendFund = useCallback(() => {
    ...
    navigate(
      "/transaction/send-fund",
      tokenGroupSlug ? { state: { slug: tokenGroupSlug } } : undefined
    );
