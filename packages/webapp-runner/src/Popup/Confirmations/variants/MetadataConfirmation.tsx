      ...
      <div className={CN("confirmation-content", className)}>
        ...
        <div className={"account-list text-center"}>
          ...
          <Typography.Paragraph className="text-tertiary">
            {t(
              "Approving this update will sync your metadata for SubWallet Connect Demo chain from" +
                " " +
                request.url
            )}
          </Typography.Paragraph>
          <Typography.Paragraph className={"text-left"}>
            <span className="__prop-label text-tertiary text-right">
              {t("Symbol")}
            </span>{" "}
...
const MetadataConfirmation = styled(Component)<Props>(
