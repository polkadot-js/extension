...
import { TransactionHistoryDisplayItem } from "@subwallet-webapp/Popup/Home/History";
...
function Component({ className = "", item, onClick }: Props) {
...
export const HistoryItem = styled(Component)<Props>(
  ({ theme: { token } }: Props) => {
    return {
