  ...
  return (
    <>
      <div className={CN("confirmation-content", className)}>
        ...
        <div className="title">{t("Approve request")}</div>
        <MetaInfo>
          ...
          <MetaInfo.Account
            ...
            label={
              request.payload.isToContract ? t("To contract") : t("To account")
            }
            name={recipient?.name}
          />
      ...
      <EvmSignArea id={id} payload={request} type={type} />
      <BaseDetailModal title={t("Transaction details")}>
...
const EvmTransactionConfirmation = styled(Component)<Props>(
