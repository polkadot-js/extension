...
export const ACALA_REFRESH_BALANCE_INTERVAL = 3000;
export const ASTAR_REFRESH_BALANCE_INTERVAL = 3000;
export const MOONBEAM_REFRESH_BALANCE_INTERVAL = 3000;
export const CRON_REFRESH_NFT_INTERVAL = 300000;
