...
export default class KoniExtension extends Extension {
  ...
  private subscribeStakeUnlockingInfo (id: string, port: chrome.runtime.Port): Record<string, UnlockingStakeInfo> {
