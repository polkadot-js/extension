...
// pages
const Welcome = new LazyLoader(() => import("@subwallet-webapp/pages/Welcome"))
const Porfolio = new LazyLoader(
  () => import("@subwallet-webapp/pages/Porfolio")
)

const Login = new LazyLoader(
  () => import("@subwallet-webapp/pages/Keyring/Login")
)
const CreatePassword = new LazyLoader(
  () => import("@subwallet-webapp/pages/Keyring/CreatePassword")
)
const ChangePassword = new LazyLoader(
  () => import("@subwallet-webapp/pages/Keyring/ChangePassword")
)
const ApplyMasterPassword = new LazyLoader(
  () => import("@subwallet-webapp/pages/Keyring/ApplyMasterPassword")
)
