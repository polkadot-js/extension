...
class AuthorizeStore extends _SubscribableStore.default {
  constructor() {
    super(_defaults.EXTENSION_PREFIX ? `${_defaults.EXTENSION_PREFIX}authorize` : null);
  }

}

exports.default = AuthorizeStore;