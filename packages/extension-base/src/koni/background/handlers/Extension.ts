...
import {
  ...
  SEED_DEFAULT_LENGTH,
  SEED_LENGTHS
} from '@subwallet/extension-base/background/handlers/Extension';
...
} from '@subwallet/extension-base/koni/api/dotsama/transfer';
...
} from '@subwallet/extension-base/koni/api/tokens/evm/transfer';
...
import { getRelayValidatorsInfo } from '@subwallet/extension-base/koni/api/yield/nativeStaking';
...
export default class KoniExtension {
  ...
  private async getYieldStakingCandidates (yieldPoolInfo: YieldPoolInfo) {
    ...
    if (yieldPoolInfo.type === YieldPoolType.NATIVE_STAKING) {
      return getRelayValidatorsInfo(yieldPoolInfo, substrateApi, decimals);
    }
  ...
  public async handle<TMessageType extends MessageTypes> (id: string, type: TMessageType, request: RequestTypes[TMessageType], port: chrome.runtime.Port): Promise<ResponseType<TMessageType>> {
    ...
    switch (type) {
      ...
      case 'pri(yield.getStakingCandidates)':
        return await this.getYieldStakingCandidates(request as YieldPoolInfo);
