...
function _SettingItemSelection(
  props: SettingItemSelectionProps
): React.ReactElement<SettingItemSelectionProps> {
...
export const SettingItemSelection = styled(
  _SettingItemSelection
)<SettingItemSelectionProps>(({ theme }) => {
  ...
  return {
    ...
    ".ant-setting-item-content": {
      padding: `${token.padding ? token.padding - 2 : 14}px ${
        token.paddingSM
      }px`,
    },
