...
function CancelStakeCompoundResult ({ backToHome, className, extrinsicHash, handleResend, isTxSuccess, networkKey, txError }: Props): React.ReactElement<Props> {
    ...
    <div className={className}>
      {
        isTxSuccess
          ? <div className={'stake-compound-result-container'}>
            ...
            <div className={'stake-compound-result-subtext'}>Your compounding request has been cancelled. It might take a minute to see changes in your wallet.</div>
          ...
          : <div className={'stake-compound-result-container'}>
            ...
            <div className={'stake-compound-result-title'}>Request Cancellation Failed</div>
...
export default React.memo(styled(CancelStakeCompoundResult)(({ theme }: Props) => `
  padding-left: 45px;
  padding-right: 45px;
