    ...
    <div className={className}>
      {
        isTxSuccess
          ? <div className={'bonding-result-container'}>
            ...
            <div className={'bonding-result-title'}>Bonded Successfully</div>

            <div className={'bonding-result-subtext'}>Your bonding request has been confirmed. It might take a minute to see changes in your wallet.</div>
          ...
          : <div className={'bonding-result-container'}>
            ...
            <div className={'bonding-result-title'}>Bonding Failed</div>
