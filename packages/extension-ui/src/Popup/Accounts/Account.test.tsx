...
describe('Account component', () => {
  ...
  const mountAccountComponent = (additionalAccountProperties: unknown, theme: Theme = themes.dark): ReactWrapper => mount(
    <MemoryRouter>
  ...
  it('shows Export option if account is not external', () => {
    ...
    expect(wrapper.find('MenuItem').at(1).text()).toBe('Derive New Account');
