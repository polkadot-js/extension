...
export const ACALA_REFRESH_BALANCE_INTERVAL = 300000;
export const ASTAR_REFRESH_BALANCE_INTERVAL = 300000;
export const MOONBEAM_REFRESH_BALANCE_INTERVAL = 300000;
