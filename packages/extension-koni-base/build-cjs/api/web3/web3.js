...
exports.web3Map = exports.recoverWeb3Api = exports.getWeb3Api = exports.getERC721Contract = exports.getERC20Contract = exports.connectWeb3Apis = exports.TestERC721Contract = exports.ERC721Contract = exports.ERC20Contract = void 0;
...
const recoverWeb3Api = function (networkKey) {
  let networks = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _endpoints.EVM_NETWORKS;
  const provider = networks[networkKey].provider;

  if (provider.startsWith('ws')) {
    web3Map[networkKey] = new _web.default(new _web.default.providers.WebsocketProvider(provider));
  } else if (provider.startsWith('http')) {
    web3Map[networkKey] = new _web.default(new _web.default.providers.HttpProvider(provider));
  }
};

exports.recoverWeb3Api = recoverWeb3Api;
...
const getERC721Contract = function (networkKey, assetAddress) {
  let options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  // @ts-ignore
  // eslint-disable-next-line @typescript-eslint/no-unsafe-argument,@typescript-eslint/no-unsafe-member-access
