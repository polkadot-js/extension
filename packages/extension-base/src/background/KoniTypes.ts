...
import { PayloadValidated } from '@subwallet/extension-base/core/logic-validation';
...
export interface ConfirmationDefinitions {
  ...
  errorConnectNetwork: [ConfirmationsQueueItem<PayloadValidated>, ConfirmationResult<null>]
}
