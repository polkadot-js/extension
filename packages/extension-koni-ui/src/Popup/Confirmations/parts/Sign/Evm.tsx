...
import { getSignMode, isEvmMessage } from '@subwallet/extension-koni-ui/utils';
...
const Component: React.FC<Props> = (props: Props) => {
  ...
  }, [checkUnlock, onConfirmInject, onApprovePassword, onConfirmLedger, onConfirmQr, signMode]);
