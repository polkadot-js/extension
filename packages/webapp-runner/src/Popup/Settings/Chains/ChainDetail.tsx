...
import { ProviderSelector } from "@subwallet-webapp/components/Field/ProviderSelector";
...
import useFetchChainState from "@subwallet-webapp/hooks/screen/common/useFetchChainState";
import { removeChain, upsertChain } from "@subwallet-webapp/messaging";
          ...
          >
            <div className={"chain_detail__attributes_container"}>
              {Object.keys(chainInfo.providers).length > 1 ? (
                <Form.Item name={"currentProvider"}>
                  <ProviderSelector
                    chainInfo={chainInfo}
                    disabled={isDeleting}
              ...
              <Row gutter={token.paddingSM}>
                ...
                <Col span={8}>
                  <Tooltip placement={"topLeft"} title={t("Symbol")}>
                    <div>
                      <Field content={symbol} placeholder={t("Symbol")} />
                    </div>
                  </Tooltip>
                </Col>
              </Row>
              ...
              <Row gutter={token.paddingSM}>
                <Col span={12}>
                  <Tooltip placement={"topLeft"} title={t("Decimals")}>
                    <div>
                      <Field content={decimals} placeholder={t("Decimals")} />
                    </div>
                  </Tooltip>
                </Col>
                <Col span={12}>
                  {!isPureEvmChain ? (
                    <Tooltip placement={"topLeft"} title={t("ParaId")}>
                      <div>
                        <Field
                    ...
                    <Tooltip placement={"topLeft"} title={t("Chain ID")}>
                      <div>
                        <Field
              ...
              <Row gutter={token.paddingSM}>
                {!isPureEvmChain && (
                  <Col span={12}>
                    <Tooltip placement={"topLeft"} title={t("Address prefix")}>
                      <div>
                        <Field
