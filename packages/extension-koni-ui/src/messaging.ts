...
export async function subscribeMantaPaySyncProgress (callback: (progress: MantaPaySyncProgress) => void): Promise<MantaPaySyncProgress> {
  return sendMessage('pri(mantaPay.subscribeSyncProgress)', null, callback);
}

export async function subscribeMantaPaySyncingState (callback: (progress: MantaPayIsSyncing) => void): Promise<MantaPayIsSyncing> {
