...
import { TokenSelectionItem } from "@subwallet-webapp/components/TokenItem/TokenSelectionItem";
...
function Component({
  ...
  const searchFunction = useCallback(
    (item: _ChainAsset, searchText: string) => {
  ...
  const onClickQrBtn = useCallback(
    (item: _ChainAsset) => {
      return () => {
...
export const TokensSelectorModal = styled(Component)<Props>(
  ({ theme: { token } }: Props) => {
    return {
