...
import { ExtrinsicType, NominatorMetadata, OptimalYieldPath, OptimalYieldPathParams, RequestCrossChainTransfer, RequestYieldStepSubmit, StakingType, TokenBalanceRaw, UnbondingSubmitParams, UnstakingInfo, YieldPoolInfo, YieldPositionInfo, YieldStepType } from '@subwallet/extension-base/background/KoniTypes';
...
import { EarningStatus, HandleYieldStepData, SubmitYieldStepData, UnstakingStatus } from '@subwallet/extension-base/types';
