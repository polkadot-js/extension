...
exports.MOONRIVER_SUPPORTED_NFT_CONTRACTS = exports.MOONBEAM_SUPPORTED_NFT_CONTRACTS = exports.ASTAR_SUPPORTED_NFT_CONTRACTS = void 0;
// Copyright 2019-2022 @polkadot/extension-koni authors & contributors
// SPDX-License-Identifier: Apache-2.0
var MOONBEAM_NFT_CONTRACT_NAME;

(function (MOONBEAM_NFT_CONTRACT_NAME) {
  MOONBEAM_NFT_CONTRACT_NAME["MOON_MONKEY"] = "Moon Monkeys";
  MOONBEAM_NFT_CONTRACT_NAME["MOON_DAO_NFT"] = "MoonDAONFT";
  MOONBEAM_NFT_CONTRACT_NAME["GLIMMER_APES"] = "GlimmerApes";
  MOONBEAM_NFT_CONTRACT_NAME["GLIMMER_JUNGLE"] = "GlimmerJungle";
  MOONBEAM_NFT_CONTRACT_NAME["MOONBEAM_BAYC"] = "Moonbeam BAYC";
  MOONBEAM_NFT_CONTRACT_NAME["MONKEY_BOTS_CULT"] = "MonkeyBotsCult";
  MOONBEAM_NFT_CONTRACT_NAME["BLOCKCHAIN_MONSTER"] = "Blockchain Monster";
  MOONBEAM_NFT_CONTRACT_NAME["DEDE_THE_KING"] = "DEDE the king!";
  MOONBEAM_NFT_CONTRACT_NAME["MOONBEAM_PUNKS"] = "Moonbeam Punks";
  MOONBEAM_NFT_CONTRACT_NAME["MOON_CITY"] = "MoonCity";
  MOONBEAM_NFT_CONTRACT_NAME["THE_FLIGHTERS"] = "The Flighters";
  MOONBEAM_NFT_CONTRACT_NAME["GLMR_PUNKS"] = "GlmrPunks";
  MOONBEAM_NFT_CONTRACT_NAME["MOONBEAM_ZUKI"] = "MoonbeamZuki";
  MOONBEAM_NFT_CONTRACT_NAME["HAMSTERS_GANG"] = "Hamsters Gang";
  MOONBEAM_NFT_CONTRACT_NAME["GLIMMER_KONGS_CLUB"] = "GlimmerKongsClub";
  MOONBEAM_NFT_CONTRACT_NAME["BORED_PUPPET_YACHT_CLUB"] = "Bored Puppet Yacht Club";
  MOONBEAM_NFT_CONTRACT_NAME["MOONBEAM_NAME_SERVICE"] = "Moonbeam Name Service (.moon)";
  MOONBEAM_NFT_CONTRACT_NAME["test"] = "test";
})(MOONBEAM_NFT_CONTRACT_NAME || (MOONBEAM_NFT_CONTRACT_NAME = {}));

const MOONBEAM_SUPPORTED_NFT_CONTRACTS = [{
...
exports.MOONBEAM_SUPPORTED_NFT_CONTRACTS = MOONBEAM_SUPPORTED_NFT_CONTRACTS;
var MOONRIVER_NFT_CONTRACT_NAME;

(function (MOONRIVER_NFT_CONTRACT_NAME) {
  MOONRIVER_NFT_CONTRACT_NAME["ZOOMBIES"] = "Zoombies";
  MOONRIVER_NFT_CONTRACT_NAME["TREASURE_LAND"] = "treasureland.dego";
  MOONRIVER_NFT_CONTRACT_NAME["CRYPTO_DATE"] = "CryptoDate";
  MOONRIVER_NFT_CONTRACT_NAME["PUPAZZI_PUNK_SALVATION"] = "Pupazzi Punk Salvation";
  MOONRIVER_NFT_CONTRACT_NAME["NEXT_GEM"] = "NextGem";
})(MOONRIVER_NFT_CONTRACT_NAME || (MOONRIVER_NFT_CONTRACT_NAME = {}));

const MOONRIVER_SUPPORTED_NFT_CONTRACTS = [{
...
exports.MOONRIVER_SUPPORTED_NFT_CONTRACTS = MOONRIVER_SUPPORTED_NFT_CONTRACTS;
var ASTAR_NFT_CONTRACT_NAME;

(function (ASTAR_NFT_CONTRACT_NAME) {
  ASTAR_NFT_CONTRACT_NAME["ASTAR_PUNKS"] = "Astar Punks";
  ASTAR_NFT_CONTRACT_NAME["KONGZ_OF_ASTAR"] = "Kongz Of Astar (KONGz)";
  ASTAR_NFT_CONTRACT_NAME["ASTAR_DEGENS"] = "AstarDegens";
  ASTAR_NFT_CONTRACT_NAME["SFY_STICKYFACTORY"] = "Cyberbeast";
  ASTAR_NFT_CONTRACT_NAME["ASTARIANS"] = "Astarians";
  ASTAR_NFT_CONTRACT_NAME["ASTAR_BOTS"] = "AstarBots";
  ASTAR_NFT_CONTRACT_NAME["ASTAR_ZODIAC"] = "Astar Zodiac collection";
  ASTAR_NFT_CONTRACT_NAME["ASTAR_KEVIN"] = "Astar Kevin";
  ASTAR_NFT_CONTRACT_NAME["ASTAR_GHOST"] = "AstarGhost";
  ASTAR_NFT_CONTRACT_NAME["KANJI_ART"] = "Kanji Art";
  ASTAR_NFT_CONTRACT_NAME["ASTAR_BORED_APES"] = "Astar Bored Apes";
  ASTAR_NFT_CONTRACT_NAME["ASTAR_PUNK_X"] = "Astar Punk X";
  ASTAR_NFT_CONTRACT_NAME["ASTAR_INVISIBLE_FRIENDS"] = "Astar Invisible Friends";
  ASTAR_NFT_CONTRACT_NAME["ASTAR_METALION_KINGDOM"] = "Astar MetaLion Kingdom";
  ASTAR_NFT_CONTRACT_NAME["ASTAR_KARAFURU"] = "Astar Karafuru";
  ASTAR_NFT_CONTRACT_NAME["ASTARNAUT"] = "Astarnaut";
  ASTAR_NFT_CONTRACT_NAME["ASTAR_CATS"] = "AstarCats";
})(ASTAR_NFT_CONTRACT_NAME || (ASTAR_NFT_CONTRACT_NAME = {}));

const ASTAR_SUPPORTED_NFT_CONTRACTS = [{
...
exports.ASTAR_SUPPORTED_NFT_CONTRACTS = ASTAR_SUPPORTED_NFT_CONTRACTS;